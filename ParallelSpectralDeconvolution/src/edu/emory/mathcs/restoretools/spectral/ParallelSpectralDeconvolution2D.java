...
import edu.emory.mathcs.restoretools.spectral.SpectralEnums.DoubleStencil2DType;
import edu.emory.mathcs.restoretools.spectral.SpectralEnums.FloatStencil2DType;
import edu.emory.mathcs.restoretools.spectral.SpectralEnums.MethodType;
import edu.emory.mathcs.restoretools.spectral.SpectralEnums.ResizingType;
import edu.emory.mathcs.restoretools.spectral.gtik.DoublePeriodicGeneralizedTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.gtik.DoubleReflexiveGeneralizedTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.gtik.FloatPeriodicGeneralizedTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.gtik.FloatReflexiveGeneralizedTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.tik.DoublePeriodicTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.tik.DoubleReflexiveTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.tik.FloatPeriodicTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.tik.FloatReflexiveTikhonov2D;
import edu.emory.mathcs.restoretools.spectral.tsvd.DoublePeriodicTruncatedSVD2D;
import edu.emory.mathcs.restoretools.spectral.tsvd.DoubleReflexiveTruncatedSVD2D;
import edu.emory.mathcs.restoretools.spectral.tsvd.FloatPeriodicTruncatedSVD2D;
import edu.emory.mathcs.restoretools.spectral.tsvd.FloatReflexiveTruncatedSVD2D;
 ...
 * 
 */
public class ParallelSpectralDeconvolution2D implements PlugIn, ImageListener {
    ...
    public static String deconvolve(String pathToBlurredImage, String pathToPsf, String pathToDeblurredImage, String methodStr, String stencilStr, String resizingStr, String outputStr, String precisionStr, String thresholdStr, String regParamStr, String nOfThreadsStr, String showPaddedStr) {
        ...
        for (DoubleStencil2DType elem : DoubleStencil2DType.values()) {
        ...
        if (stencil == null) {
            return "stencil must be in " + Arrays.toString(DoubleStencil2DType.values());
        }
        ...
        case DOUBLE:
            switch (method) {
            case GTIK_REFLEXIVE:
                DoubleReflexiveGeneralizedTikhonov2D dgtik_dct = new DoubleReflexiveGeneralizedTikhonov2D(imB, imPSF, DoubleStencil2DType.valueOf(stencil).stencil, resizing, output, showPadded, regParam, threshold);
                imX = dgtik_dct.deconvolve();
                break;
            case GTIK_PERIODIC:
                DoublePeriodicGeneralizedTikhonov2D dgtik_fft = new DoublePeriodicGeneralizedTikhonov2D(imB, imPSF, DoubleStencil2DType.valueOf(stencil).stencil, resizing, output, showPadded, regParam, threshold);
                imX = dgtik_fft.deconvolve();
                break;
            case TIK_REFLEXIVE:
                DoubleReflexiveTikhonov2D dtik_dct = new DoubleReflexiveTikhonov2D(imB, imPSF, resizing, output, showPadded, regParam, threshold);
                imX = dtik_dct.deconvolve();
                break;
            case TIK_PERIODIC:
                DoublePeriodicTikhonov2D dtik_fft = new DoublePeriodicTikhonov2D(imB, imPSF, resizing, output, showPadded, regParam, threshold);
                imX = dtik_fft.deconvolve();
                break;
            case TSVD_REFLEXIVE:
                DoubleReflexiveTruncatedSVD2D dtsvd_dct = new DoubleReflexiveTruncatedSVD2D(imB, imPSF, resizing, output, showPadded, regParam, threshold);
                imX = dtsvd_dct.deconvolve();
                break;
            case TSVD_PERIODIC:
                DoublePeriodicTruncatedSVD2D dtsvd_fft = new DoublePeriodicTruncatedSVD2D(imB, imPSF, resizing, output, showPadded, regParam, threshold);
        ...
        case SINGLE:
            switch (method) {
            case GTIK_REFLEXIVE:
                FloatReflexiveGeneralizedTikhonov2D dgtik_dct = new FloatReflexiveGeneralizedTikhonov2D(imB, imPSF, FloatStencil2DType.valueOf(stencil).stencil, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dgtik_dct.deconvolve();
                break;
            case GTIK_PERIODIC:
                FloatPeriodicGeneralizedTikhonov2D dgtik_fft = new FloatPeriodicGeneralizedTikhonov2D(imB, imPSF, FloatStencil2DType.valueOf(stencil).stencil, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dgtik_fft.deconvolve();
                break;
            case TIK_REFLEXIVE:
                FloatReflexiveTikhonov2D dtik_dct = new FloatReflexiveTikhonov2D(imB, imPSF, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dtik_dct.deconvolve();
                break;
            case TIK_PERIODIC:
                FloatPeriodicTikhonov2D dtik_fft = new FloatPeriodicTikhonov2D(imB, imPSF, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dtik_fft.deconvolve();
                break;
            case TSVD_REFLEXIVE:
                FloatReflexiveTruncatedSVD2D dtsvd_dct = new FloatReflexiveTruncatedSVD2D(imB, imPSF, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dtsvd_dct.deconvolve();
                break;
            case TSVD_PERIODIC:
                FloatPeriodicTruncatedSVD2D dtsvd_fft = new FloatPeriodicTruncatedSVD2D(imB, imPSF, resizing, output, showPadded, (float) regParam, (float) threshold);
                imX = dtsvd_fft.deconvolve();
                break;
            }
            break;
    ...
    private DoubleReflexiveGeneralizedTikhonov2D dgtik_dct;

    private DoublePeriodicGeneralizedTikhonov2D dgtik_fft;

    private DoublePeriodicTikhonov2D dtik_fft;

    private DoubleReflexiveTikhonov2D dtik_dct;

    private DoublePeriodicTruncatedSVD2D dtsvd_fft;

    private DoubleReflexiveTruncatedSVD2D dtsvd_dct;

    private FloatReflexiveGeneralizedTikhonov2D fgtik_dct;

    private FloatPeriodicGeneralizedTikhonov2D fgtik_fft;

    private FloatPeriodicTikhonov2D ftik_fft;

    private FloatReflexiveTikhonov2D ftik_dct;

    private FloatPeriodicTruncatedSVD2D ftsvd_fft;

    private FloatReflexiveTruncatedSVD2D ftsvd_dct;
    ...
    public void run(String arg) {
        ...
        mainPanel = new MainPanel("Parallel Spectral Deconvolution 2D " + version + " ");
    }
                ...
                Thread thread = new Thread(new Runnable() {
                    public void run() {
                        ...
                        case DOUBLE:
                            switch (selMethod) {
                            case GTIK_REFLEXIVE:
                                dgtik_dct = new DoubleReflexiveGeneralizedTikhonov2D(imB, imPSF, DoubleStencil2DType.values()[stencilChoice.getSelectedIndex()].stencil, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck
                                ...
                                break;
                            case GTIK_PERIODIC:
                                dgtik_fft = new DoublePeriodicGeneralizedTikhonov2D(imB, imPSF, DoubleStencil2DType.values()[stencilChoice.getSelectedIndex()].stencil, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck
                                        .isSelected(), regParam, threshold);
                                imX = dgtik_fft.deconvolve();
                                timer.stop();
                                regField.setText(String.format("%.6f", imX.getProperty("regParam")));
                                ...
                                break;
                            case TIK_REFLEXIVE:
                                dtik_dct = new DoubleReflexiveTikhonov2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), regParam, threshold);
                                imX = dtik_dct.deconvolve();
                                timer.stop();
                                regField.setText(String.format("%.6f", imX.getProperty("regParam")));
                                regSlider.setValue((Double) imX.getProperty("regParam"));
                                ...
                                break;
                            case TIK_PERIODIC:
                                dtik_fft = new DoublePeriodicTikhonov2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), regParam, threshold);
                                imX = dtik_fft.deconvolve();
                                timer.stop();
                                regField.setText(String.format("%.6f", imX.getProperty("regParam")));
                                regSlider.setValue((Double) imX.getProperty("regParam"));
                                ...
                                break;
                            case TSVD_REFLEXIVE:
                                dtsvd_dct = new DoubleReflexiveTruncatedSVD2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), regParam, threshold);
                                imX = dtsvd_dct.deconvolve();
                                timer.stop();
                                regField.setText(String.format("%.6f", imX.getProperty("regParam")));
                                regSlider.setValue((Double) imX.getProperty("regParam"));
                                ...
                                break;
                            case TSVD_PERIODIC:
                                dtsvd_fft = new DoublePeriodicTruncatedSVD2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), regParam, threshold);
                                imX = dtsvd_fft.deconvolve();
                                timer.stop();
                                regField.setText(String.format("%.6f", imX.getProperty("regParam")));
                                regSlider.setValue((Double) imX.getProperty("regParam"));
                        ...
                        case SINGLE:
                            switch (selMethod) {
                            case GTIK_REFLEXIVE:
                                fgtik_dct = new FloatReflexiveGeneralizedTikhonov2D(imB, imPSF, FloatStencil2DType.values()[stencilChoice.getSelectedIndex()].stencil, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck
                                ...
                                break;
                            case GTIK_PERIODIC:
                                fgtik_fft = new FloatPeriodicGeneralizedTikhonov2D(imB, imPSF, FloatStencil2DType.values()[stencilChoice.getSelectedIndex()].stencil, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck
                                        .isSelected(), (float) regParam, (float) threshold);
                                ...
                                break;
                            case TIK_REFLEXIVE:
                                ftik_dct = new FloatReflexiveTikhonov2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), (float) regParam, (float) threshold);
                                ...
                                break;
                            case TIK_PERIODIC:
                                ftik_fft = new FloatPeriodicTikhonov2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), (float) regParam, (float) threshold);
                                ...
                                break;
                            case TSVD_REFLEXIVE:
                                ftsvd_dct = new FloatReflexiveTruncatedSVD2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), (float) regParam, (float) threshold);
                                ...
                                break;
                            case TSVD_PERIODIC:
                                ftsvd_fft = new FloatPeriodicTruncatedSVD2D(imB, imPSF, ResizingType.values()[resizingChoice.getSelectedIndex()], OutputType.values()[outputChoice.getSelectedIndex()], paddedCheck.isSelected(), (float) regParam, (float) threshold);
