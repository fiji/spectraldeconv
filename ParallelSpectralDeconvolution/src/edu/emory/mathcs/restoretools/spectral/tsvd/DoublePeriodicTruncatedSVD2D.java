 ...
 */
package edu.emory.mathcs.restoretools.spectral.tsvd;
...
public class DoublePeriodicTruncatedSVD2D extends AbstractDoubleSpectralDeconvolver2D {
     ...
     */
    public DoublePeriodicTruncatedSVD2D(ImagePlus imB, ImagePlus imPSF, ResizingType resizing, OutputType output, boolean showPadded, double regParam, double threshold) {
