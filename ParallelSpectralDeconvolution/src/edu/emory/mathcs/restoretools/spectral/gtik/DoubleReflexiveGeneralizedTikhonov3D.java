...
public class DoubleReflexiveGeneralizedTikhonov3D extends AbstractDoubleSpectralDeconvolver3D {
     ...
     */
    public DoubleReflexiveGeneralizedTikhonov3D(ImagePlus imB, ImagePlus imPSF, DoubleMatrix3D stencil, ResizingType resizing, OutputType output, boolean showPadded, double regParam, double threshold) {
